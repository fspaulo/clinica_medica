...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #f3f3f3;">
	<div class="container px-4 px-lg-5">
		<a class="navbar-brand" href="<?= site_url()?>home">Cliníca Médica</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
				...
				<li class="nav-item"><a class="nav-link" href="<?= site_url() ?>especialidades">Especialidades</a></li>
				<li class="nav-item"><a class="nav-link" href="<?= site_url() ?>medicos">Médicos</a></li>
				<li class="nav-item"><a class="nav-link" href="<?= site_url() ?>pacientes">Pacientes</a></li>
