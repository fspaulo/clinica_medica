	...
	<div class="container">
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<h3 class="mb-3">Clínica Médica</h3>
				<div class="bg-white shadow rounded">
					<div class="row">
						<div class="col-md-7 pe-0">
							<div class="form-left h-100 py-5 px-5">
								<form action="<?php base_url() ?>login/logar" method="post" class="row g-4">
									<div class="col-12">
										<label for="usuario">Usuário<span class="text-danger">*</span></label>
										<div class="input-group">
											<div class="input-group-text"><i class="bi bi-person-fill"></i></div>
											<input type="text" name="usuario" id="usuario" class="form-control"
												   placeholder="Entre com o usuário" required autofocus>
										</div>
									</div>
