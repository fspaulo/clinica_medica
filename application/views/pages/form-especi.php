			...
			<div class="card">
				...
				<?php endif; ?>
						...
						<div class="col-md-5">
							...
							<input type="text" class="form-control" id="nome" name="nome" value="<?= isset($especialidade) ? $especialidade["nome"] : "" ?>">
						</div>
						<div class="col-md-3">
							<label for="valor" class="form-label">Valor</label>
							<input type="text" class="form-control" placeholder="" id="valor" name="valor" value="<?= isset($especialidade) ? $especialidade["valor"] : "" ?>">
						</div>
						<div class="col-12">
